...
// функция инициализации, определяется без параметров и результата
// вызывается автоматически и предоставляет возможность подготовить пакет к использованию
// может быть определено несколько функций init
func init() {
